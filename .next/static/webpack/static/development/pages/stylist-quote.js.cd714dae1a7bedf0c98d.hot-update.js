  ...
  function StylistList(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      ...
      if (_this.props.isStylistQuote) {
        _this.setState({
          isStylistQuote: true,
          stylistProviderId: _this.props.id
        }, function () {
          axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('https://express-server-ap-southeast-2.flayr.io/stylist/' + _this.props.id).then(function (response) {
            _this.setState({
...
//# sourceMappingURL=stylist-quote.js.cd714dae1a7bedf0c98d.hot-update.js.map